...
router.post("/search_business", async (req, res) => {
  try {
    let newArray = [];
    ...
    var count = await MyBusiness.countDocuments({
      $or: newArray,
    });
    res.json({
      statusCode: 200,
