...
router.post("/login", async (req, res) => {
  try {
    ...
    let isMatch;
    const useHashCompare = true;  // Set this variable based on your condition

    if (useHashCompare) {
      isMatch = await hashCompare(req.body.password, user.password);
    } else {
      // Add your custom password check logic here
...
router.put("/register/:id", async (req, res) => {
  try {
    // Hash the password and cPassword fields if they are present in the request body
