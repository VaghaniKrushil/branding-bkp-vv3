  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <TableCell align="center"> {row.C_D_type}</TableCell>
...
export default function AllHistory() {
  ...
  const getData = async () => {
    ...
    try {
      const res = await axios.get(
        "https://brandingprofitable-29d465d7c7b1.herokuapp.com/mlm/allhistory",
        {
          params: {
  ...
  let handleSearchData = async (values) => {
    ...
    let res = await axios.post(
      "https://brandingprofitable-29d465d7c7b1.herokuapp.com/mlm/allhistory/search",
      {
        search: values,
      }
    );
