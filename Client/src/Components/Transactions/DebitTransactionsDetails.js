...
export default function DebitTransactionsDetails() {
  let navigate = useNavigate();
  ...
  const getData = async () => {
    ...
    try {
      const res = await axios.get(
        `https://brandingprofitable-29d465d7c7b1.herokuapp.com/mlm/total_debit_history/${number}`,
        {
          params: {
