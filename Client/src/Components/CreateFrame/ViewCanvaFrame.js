...
function Row(props) {
  ...
  let handleEditButtonClick = async () => {
    let response = await axios.post(
      "https://brandingprofitable-29d465d7c7b1.herokuapp.com/frame/framaid",
      {
        CanvaFrameIdForEdit: row._id,
      }
    );
  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <TableCell align="center">{row.cds_imageName}</TableCell> */}
        <TableCell align="center">
          <a
            href={imagePath + row.frameImage}
            target="_blank"
            rel="noopener noreferrer"
          >
            <img
              src={imagePath + row.frameImage}
              alt={row.frameImage}
              width="50px"
              height="50px"
            />
...
export default function ViewCanvaFrame() {
  let navigate = useNavigate();
  ...
  let getData = async () => {
    let res = await axios.post(
      "https://brandingprofitable-29d465d7c7b1.herokuapp.com/frame/get_frame",
      {
    ...
    setCountData(res.data.frameCount);
    setTotalImage(res.data.frameCount);
  };
  ...
  var handleDelete = () => {
    swal("Are You Sure You Want TO Delete ?", {
      ...
      if (buttons === true) {
        axios
          .delete(
            "https://brandingprofitable-29d465d7c7b1.herokuapp.com/frame/frame_delete",
            {
              data: selected,
            }
          )
  ...
  let handleSearchData = async (values) => {
    let res = await axios.post(
      "https://brandingprofitable-29d465d7c7b1.herokuapp.com/cds_category/search_cds_category",
      {
        search: values,
      }
    );
  ...
  const filterDate = async () => {
    if (data.startingDate && data.endingDate) {
      ...
      let response = await axios.post(
        "https://brandingprofitable-29d465d7c7b1.herokuapp.com/frame/filterData/",
        {
