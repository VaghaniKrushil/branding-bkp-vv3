  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <TableCell align="center">
      {/* <Link to={`/user-transaction/${row.number}`}> */}
        {row.number}
      {/* </Link> */}
    </TableCell>
        {/* <TableCell align="center">
...
export default function TodayMlmJoinUser() {
  ...
  const getData = async () => {
    try {
      ...
      const res = await axios.get(
        "https://brandingprofitable-29d465d7c7b1.herokuapp.com/mlm/totaljoin",
        {
          params: {
      ...
      setCountData(res.data.totalJoinCount); // Make sure to adjust the key here
    } catch (error) {
  ...
  let handleSearchData = async (values) => {
    ...
    let res = await axios.post(
      "https://brandingprofitable-29d465d7c7b1.herokuapp.com/mlm/totaljoin/search",
      {
        search: values,
      },
    );
    ...
    <>
      ...
      <Box sx={{ width: "100%", pb: "2%", pl: "2%", pr: "2%" }}>
        ...
        <Paper sx={{ width: "100%" }} className="table_bg_img">
          ...
          {loader || selectDataLoader || searchLoader ? (
            <div className="d-flex flex-direction-row justify-content-center align-items-center p-5 m-5">
              <RotatingLines
                ...
                width="50"
                visible={loader || selectDataLoader || searchLoader}
              />
            </div>
          ) : (
            <TableContainer>
