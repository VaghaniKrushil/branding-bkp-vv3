...
// function FrameRequestResponce() {
//   return (
//     <div>FrameRequestResponce</div>
//   )
// }

// export default FrameRequestResponce
...
export default function FrameRequestResponce() {
  let navigate = useNavigate();
  ...
  let getData = async () => {
    let res = await axios.get(
      "https://brandingprofitable-29d465d7c7b1.herokuapp.com/framerespoce/frame/responce",
      {
        params: {
  ...
  var handleDelete = () => {
    axios
      .delete("https://brandingprofitable-29d465d7c7b1.herokuapp.com/framerespoce/frame/responce", {
        data: selected,
      })
      .then((response) => {
