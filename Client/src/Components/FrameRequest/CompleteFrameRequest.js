  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <TableCell align="center">{row.fullName_user}</TableCell>
        ...
        <TableCell align="center">
          <img
            src={imagePath + row.savedFrame_user}
            alt={row.savedFrame_user}
            width="50px"
            height="50px"
...
export default function CompleteFrameRequest() {
  let navigate = useNavigate();
...
//       "https://brandingprofitable-29d465d7c7b1.herokuapp.com/framerequest/framerequest/complete",
//       {
//         params: {
...
let getData = async () => {
    ...
    setLoader(false);
    setAdvertiseBanner(res.data.data);
    setCountData(res.data.CompleteFrameCount);
  };
  ...
  var handleDelete = () => {
    axios
      .delete("https://brandingprofitable-29d465d7c7b1.herokuapp.com/framerequest/complete/framerequest", {
        data: selected,
      })
      .then((response) => {
  ...
  let handleSearchData = async (values) => {
    let res = await axios.post(
      "https://brandingprofitable-29d465d7c7b1.herokuapp.com/framerequest/comp_framerequest/search",
      {
        search: values,
      },
    );
