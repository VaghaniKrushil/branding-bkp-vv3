  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <TableCell align="center">{row.advertiseBannerName}</TableCell>
        {/* <TableCell align="center">{row.bannerImage}</TableCell> */}
        <TableCell align="center">
          <img
            src={imagePath + row.advertiseImage}
            alt={row.advertiseImage}
            width="50px"
            height="50px"
          />
        </TableCell>
        <TableCell align="center">{row.advertiseLink}</TableCell>
        {/* <TableCell align="center">
          {row.bannerSwitch === true ? "True" : "False"}
        </TableCell> */}
        <TableCell align="center">
          <div>
            <Switch {...label} checked={row.advertiseSwitch} />
          </div>
        </TableCell>
...
export default function MainBanner() {
  ...
  let handleSearchData = async (values) => {
    const token = cookies.get("token");
    let res = await axios.post(
      "https://brandingprofitable-29d465d7c7b1.herokuapp.com/advertise_banner/banner/search",
      {
        search: values,
      },
      {
  ...
  const filterDate = async () => {
    if (data.startingDate && data.endingDate) {
      ...
      let response = await axios.post(
        "https://brandingprofitable-29d465d7c7b1.herokuapp.com/advertise_banner/filterData/",
        {
 ...
 let getDefaultAdvertiseBanner = async () => {
   let responce = await axios.get(
     "https://brandingprofitable-29d465d7c7b1.herokuapp.com/default_banner/advertise_banner_default"
   );
          ...
          <table>
            ...
            <tbody>
              {defaultAdvertiseBanner?.map((row, id) => {
                if (row.defaultBannerType === "Advertise Banner") {
                  return (
                    <tr key={id}>
                      <td>
                        <img
