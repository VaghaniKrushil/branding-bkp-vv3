    ...
    const getData = async () => {
        ...
        try {
            const res = await axios.get(
                "https://brandingprofitable-29d465d7c7b1.herokuapp.com/categorydays/categorydays",
                {
                    params: {
        ...
        handleSubmit = async (values) => {
            ...
            try {
                const response = await axios.put(
                    `https://brandingprofitable-29d465d7c7b1.herokuapp.com/categorydays/categorydays/${id}`, // Use template literals to include the id
                    values,
                    {
                        headers: {
                            Authorization: `Bearer ${token}`,
