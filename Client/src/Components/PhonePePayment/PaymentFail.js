  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <TableCell align="center">{row?.data?.data?.paymentInstrument?.type}</TableCell>
...
export default function PaymentFail() {
  ...
  const getData = async () => {
    ...
    try {
      const res = await axios.get(
        "https://brandingprofitable-29d465d7c7b1.herokuapp.com/payments/fail",
        {
          params: {
  ...
  let handleSearchData = async (values) => {
    ...
    // const token = cookies.get("token");
    let res = await axios.post(
      "https://brandingprofitable-29d465d7c7b1.herokuapp.com/payments/fail_search",
      {
        search: values,
      },
      // {
