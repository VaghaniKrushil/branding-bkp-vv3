  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <TableCell align="center">
          <div>
            <Switch {...label} checked={row.cds_categorySwitch} />
          </div>
        </TableCell>
...
export default function CustomeDynamicSectionCategory() {
  let navigate = useNavigate();
  ...
  let getData = async () => {
    ...
    let res = await axios.get(
      "https://brandingprofitable-29d465d7c7b1.herokuapp.com/cds_category/category",
      {
        params: {
    ...
    setCountData(res.data.CDS_CategoryCount);
  };
  ...
  let handleSearchData = async (values) => {
    let res = await axios.post(
      "https://brandingprofitable-29d465d7c7b1.herokuapp.com/cds_category/category/search",
      {
        search: values,
      },
    );
  ...
  const filterDate = async () => {
    if (data.startingDate && data.endingDate) {
      ...
      let response = await axios.post(
        "https://brandingprofitable-29d465d7c7b1.herokuapp.com/cds_category/filterData/",
        {
  ...
  return (
    <>
      ...
      >
        <DialogTitle>{"Categort Form"}</DialogTitle>
